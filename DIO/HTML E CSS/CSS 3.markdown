...
## Estiliziando listas
 ...
 existem listas ordenadas e não ordenadas e pra alterar o marcador dessas listas nos usamos o
 list-style-type.

  ul {
  	list-style-type: square ---> ALTERANDO O MARCADOR DA LISTA NÃO ORDENADA PARA UM QUADRADO
  }
 
 ol {
 	lis-style-type: upper-roman; ---> ALTERANDO O MARCADOR DE UMA LISTA ORDERNADA PARA UM ALGORISMO ROMANO MAIÚSCULO
 }

 ul {
 	list-style-type: "\1F44D"; --- ALTERANDO O MARCADOR DE UMA LISTA NÃO ORDENADA PARA UM SIMBULO
 }

 ul{
 	list-style-image: url("rocket.png"); ALTERANDO O MARCADO NÃO ORDENADO PARA UMA IMAGEM
 }

## Dimensão e alinhamento

Width e o hight ajustam a largura e altura respectivamente

Max-widht e Max-height ele se referem a largura máxima e altura máxima que esses elementos podem ter

Margin serve para colocar espaçamento entre elementos, mas ele tem o valor auto, que serve para alinhar algum elemento automáticamente

Text align serve para alinhar textos e pode alinhar a esquerda com o valor "left" e a direita com o valor "right" ao centro com o valor "center" e justificar o texto com o valor
"justfive"